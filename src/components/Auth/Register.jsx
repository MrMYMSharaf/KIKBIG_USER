...
const Register = () => {
  ...
  const handleGoogleSignup = () => {
    ...
    const oauthUrl = `${import.meta.env.VITE_API_URL}/api/auth/google`;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center overflow-hidden relative">
      ...
      <div className="w-full h-screen flex">
        {/* Left Side - Phone Register */}
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 bg-gradient-to-br from-red-50 via-white to-orange-50 order-2 lg:order-1">
          <style>{`
            /* 3D Phone Frame */
            .phone-frame {
              position: relative;
          ...
          <div className="phone-frame relative z-10">
            ...
            {/* Phone Screen with Register Form */}
            <div className="phone-screen">
              <div className="p-5 max-h-[640px] overflow-y-auto custom-scrollbar">
                ...
                <div className="text-center mb-4 pt-4">
                  ...
                  <h1 className="text-xl font-bold text-gray-800">Join KiKBiG</h1>
                  <p className="text-xs text-gray-500">Create your account today</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-2.5">
                  {/* Username */}
                  <div>
                    <label className="block text-[10px] font-bold text-gray-700 mb-1 uppercase tracking-wide">Username</label>
                    <input
                      type="text"
                      name="name"
                      value={form.name}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-gray-700 mb-1 uppercase tracking-wide">Phone</label>
                    <PhoneInput
                      international
                      defaultCountry="LK"
                      value={form.phone}
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-500 to-blue-800 text-white p-2.5 rounded-lg font-bold hover:from-blue-800 hover:to-blue-950 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none text-xs mt-2"
                    disabled={isLoading}
                  >
                    {isLoading ? (
                ...
                <button
                  ...
                  type="button"
                  className="w-full bg-white border-2 border-gray-200 text-gray-700 p-2.5 rounded-lg flex items-center justify-center hover:bg-gray-50 hover:border-gray-300 transition-all font-bold shadow-sm hover:shadow text-xs"
                >
                ...
                {/* Login Link */}
                <div className="mt-3 text-center p-2.5 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg">
                  <p className="text-gray-700 text-xs">
                    Already have an account?{" "}
                    <Link to="/auth" className="text-blue-600 hover:text-blue-700 font-bold">
                      Log in
                    </Link>
                  </p>
                </div>
        ...
        {/* Right Side - Background Image with Frame */}
        <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-8 bg-gradient-to-br from-gray-100 to-gray-200 order-1 lg:order-2">

...
const Choose = ({ handleChoose, handleClose }) => {
  ...
  return (
    ...
    >
      ...
      {/* Centered Content */}
      <div className="relative bg-white/95 backdrop-blur-md p-6 sm:p-10 rounded-3xl shadow-2xl flex flex-col items-center space-y-6 sm:space-y-8 border-4 border-primary max-w-sm sm:max-w-lg md:max-w-2xl w-full mx-4 animate-slideUp">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-600 text-sm sm:text-base">Select what you want to share today</p>
        </div>

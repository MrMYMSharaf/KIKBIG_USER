...
// import { useGetAdvertisementQuery } from '../../features/authSlice';
// import { useNavigate } from "react-router-dom";

// const ViewAllAds = () => {
//   const [layout, setLayout] = useState('grid');
//   const { data: advertisements, isLoading, isError ,isSuccess } = useGetAdvertisementQuery();
...
//   if (isError) {
//     return <div>Failed to load advertisement.</div>;
//   }
...
//         >
//           {advertisements[0].map((advertisement) => (
